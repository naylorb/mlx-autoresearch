...
def verify_env():
    if sys.platform != "darwin":
        raise RuntimeError(f"This script requires macOS with Apple Silicon. Detected platform: {sys.platform}")
    try:
        import mlx.core
    except ImportError:
...
def train_tokenizer():
    ...
    # Build token_bytes lookup for BPB evaluation — saved as .npy (not .pt)
