...
3. peak memory in GB, round to .1f (e.g. 1.2 — divide peak_memory_mb by 1024) — use 0.0 for crashes
...
```
commit	val_bpb	memory_gb	status	description
a1b2c3d	0.997900	1.2	keep	baseline
b2c3d4e	0.993200	1.3	keep	increase LR to 0.04
c3d4e5f	1.005000	1.2	discard	switch to GeLU activation
